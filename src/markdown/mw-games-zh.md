...
游玩作品前需要先下载 Mario Worker，建议游玩时下载作品对应的版本。作品列表中的 MW 版本号旁有对应版本的下载按钮；Super Mario Worker Project 下载页包含所有可用的 SMWP 版本。对于 SMWP v1.4+ 以及有替换音乐的作品，不要忘记下载并正确放置/替换音乐包！
