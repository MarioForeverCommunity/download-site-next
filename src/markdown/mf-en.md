...
2. The installer for v3.50 is a Chinese repackage. This version contains a bug in World 4-2 that prevents from progressing through the game, which was fixed in v3.51.
