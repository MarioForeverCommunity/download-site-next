...
4. The version numbers v5.9s and v5.9r were designated for clarity. v5.9 has two installers with different timestamps; the files they install are identical. The v5.9r executable was last modified on 2013-01-18, while the installer [appears to have been released on 2014-06-26](https://archive.marioforever.net/post/3258680750.html). This version is known to be non-functional.
