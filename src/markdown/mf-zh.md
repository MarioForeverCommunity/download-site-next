...
<a class="md-button" target="_blank" href="https://www.123684.com/s/U3vrVv-VD0f.html">原版 Mario Forever 备用下载地址 (提取码：MAat)</a><ClipboardButton lan="zh" code="MAat" />
...
5. v5.9s/v5.9r 的版本号系为区分之用；v5.9s 有两个不同日期的安装包，安装后的文件相同；v5.9r 的主程序修改日期为 2013-01-18，而[安装程序放出的日期疑似为 2014-06-26](https://archive.marioforever.net/post/3258680750.html)；该版本无法运行。
