...
<a class="md-button" target="_blank" href="https://file.marioforever.net/Mario%20Forever/%E5%9B%BD%E5%A4%96%E4%BD%9C%E5%93%81/Meteo%20Dream/Mario%20Forever%20Community%20Edition%202.1.2%20Windows.zip">下载最新版 Mario Forever: Community Edition</a>
...
4. v5.011/v5.013 安装后的文件与 v5.01 完全相同，v5.08b 安装后的文件与 v5.08 相同。
...
6. v6.0 及以后的版本官方的版本号比较混乱，v6.0，v6.01，v6.1，v6.11 是为了明确区分而指定的版本号。v6.1/v6.11 的文件来源于 Softendo 的 Super Mario Forever 2016 Pack。
7. v7.02e 的游戏主程序与 v7.02_31 Beta 完全相同，其安装程序的原始文件名为 `super-mario-forever-v702e.exe`。
8. Advance v4.4 (2011) 的发布日期指 exe 文件的修改日期。
9. 绿色版移除了全部图标文件、url 快捷方式、卸载程序和广告插件安装包。
</div>