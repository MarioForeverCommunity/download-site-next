...
const TAG_COLOR_MAP = {
  ...
  "Mod":          { bg: "#e8e8e8", border: "#909090", text: "#606060" },
  ...
  "Remake":       { bg: "#e3ecf5", border: "#78a0c8", text: "#5078a0" },
...
const TAG_COLOR_MAP_DARK = {
  ...
  "Mod":          { bg: "#282828", border: "#A7A7A7", text: "#A7A7A7" },
  ...
  "Remake":       { bg: "#1e2838", border: "#78A0C8", text: "#78A0C8" },
