...
const TAG_COLOR_MAP = {
  ...
  "Festive":      { bg: "#d8e8fc", border: "#5090e0", text: "#3068b8" },
  ...
  "Other":        { bg: "#e4e8f4", border: "#8898c0", text: "#6070a0" },
  "PK!MF":        { bg: "#fce4e4", border: "#d0706e", text: "#b84a48" },
  "Remake":       { bg: "#e0eaf5", border: "#6888b5", text: "#486898" },
  ...
  "Platformer":       { bg: "#e0eaf5", border: "#6888b5", text: "#486898" },
...
const TAG_COLOR_MAP_DARK = {
  ...
  "Festive":      { bg: "#182838", border: "#60A5FA", text: "#60A5FA" },
  ...
  "Other":        { bg: "#1e2430", border: "#8899C6", text: "#8899C6" },
  "PK!MF":        { bg: "#3a2020", border: "#da6260", text: "#da6260" },
  "Remake":       { bg: "#1e2838", border: "#7C9FCD", text: "#7C9FCD" },
  ...
  "Platformer":       { bg: "#1e2838", border: "#7C9FCD", text: "#7C9FCD" },
